...
public class GoalFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Set title
        ((FragmentActivityNew)getActivity()).getSupportActionBar().setTitle("Goal");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        // Inflate menu
        MenuInflater menuInflater = ((FragmentActivityNew)getActivity()).getMenuInflater();
    ...
    public void editGoalSubmitOnClick(){
        ...
        if(error == 0) {
            ...
            if(stringUserGender.startsWith("m")){
                // Male
                // BMR = 88.362 + (13.397 x kg body weight) + (5.003x height in cm) - (5.677 x age)
                goalEnergyBMR = 88.362+(13.397*doubleCurrentWeight)+(5.003*doubleUserHeight)-(5.677*intUserAge);


            }
            else{
                // Female
                // BMR = 447.593 + (9.247 x kg body weight) + (3.098 x height in cm) - (4.330 x age)
