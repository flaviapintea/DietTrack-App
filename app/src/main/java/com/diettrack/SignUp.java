...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonSignUp = (Button)findViewById(R.id.buttonNext);
    ...
    public void signUpSubmit() {
        ...
        if(errorMessage.isEmpty()){
            ...
            // Input for users
            String stringInput = "NULL, " + stringNameSQL + "," + dateOfBirthSQL + "," + stringGenderSQL + "," + heightCmSQL + "," + stringMesurmentSQL;
            db.insert("users", "_id, user_name, user_dob, user_gender, user_height, user_mesurment",
                    stringInput);
